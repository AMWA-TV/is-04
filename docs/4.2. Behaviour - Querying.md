...
The three timestamps are permitted to be identical. For more details of the timing model used in NMOS specifications, see [MS-04](https://specs.amwa.tv/ms-04/).
