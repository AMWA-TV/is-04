...
The preferred method of Registration API advertisement is via unicast DNS. Registration APIs MUST additionally be capable of producing an mDNS advertisement of the type \_nmos-register.\_tcp. This MAY be disabled via a user-configurable method.
...
The preferred method of Query API advertisement is via unicast DNS. Query APIs MUST additionally be capable of producing an mDNS advertisement of the type \_nmos-query.\_tcp. This MAY be disabled via a user-configurable method.
