...
4. Using the returned list of Nodes, the requesting Node may request data from remote Node API resources as needed to populate a control interface. This may be as simple as requesting the '/senders' resource.
